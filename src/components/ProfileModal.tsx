        ...
        <div className="bg-gradient-to-br from-[#073D33] via-[#095748] to-[#042822] text-white p-6 sm:p-7 relative shrink-0">
          ...
          <div className="flex items-center gap-4 mb-5">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xs font-semibold text-emerald-200/90 truncate mt-0.5">
                {phone ? `${phone} • tamreen.app` : 'jobayer.tamreen@gmail.com'}
              </p>
              <button
                onClick={() => setActiveTab('edit_profile')}
                className="mt-2 inline-flex items-center gap-1 text-[11px] font-extrabold text-amber-300 hover:text-amber-200 underline cursor-pointer"
              >
