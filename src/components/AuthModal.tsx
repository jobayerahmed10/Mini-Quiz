...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  const handleLoginSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const name = profile.full_name || userMeta.full_name || 'পরীক্ষার্থী';
  ...
  const handleRegisterSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const saved = saveUserProfile(cleanName, cleanPhone, '');
  ...
  return (
    ...
    >
      <div 
        id="auth-modal-card"
        className="w-full max-w-[440px] bg-[#F8FAF9] dark:bg-[#070D1E] rounded-[32px] shadow-2xl border border-emerald-900/10 dark:border-emerald-500/20 overflow-hidden relative my-auto text-slate-800 dark:text-slate-100 transition-all"
      >
        ...
        <div className="p-6 sm:p-8 space-y-6">
          ...
          {/* Top Bar with Back Button / Branding Header */}
            ...
            <div className="space-y-4 animate-fade-in">
              ...
              <form onSubmit={handleRegisterSubmit} className="space-y-3.5">
                ...
                <div className="flex items-start gap-2.5 pt-1">
                  ...
                  />
                  <label htmlFor="register-terms-checkbox" className="text-[11px] font-bold text-slate-600 dark:text-slate-300 select-none cursor-pointer">
          ...
          {/* ================================================================ */}
          {/* SCREEN 3: PASSWORD RESET (FORGOT PASSWORD)                       */}
          {/* ================================================================ */}
